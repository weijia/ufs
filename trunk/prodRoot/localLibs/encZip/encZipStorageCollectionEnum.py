...
class extractedZipStorageItem(ufsObj.objInCollection):
    def __init__(self, rootPath, fullPath, itemInfo, zipFileFullPath, zipFileObj, pathInZipFile):
        ...
        super(extractedZipStorageItem, self).__init__(pathInZipFile, itemInfo)
...
class encZipStorageCollectionEnum(synchronizableCollection.synchronizableCollection):
