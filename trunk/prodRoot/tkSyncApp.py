import Tkinter
import tkFileDialog
import localLibs.config.configDict as configDict
#import StringVar
import tkMessageBox
import sys
...
import localLibs.xmlRpcClient.syncClient as syncClient
...
class tkSyncApp:
    ...
    def callSyncObj(self, folder = "d:/tmp/test/source", encryptionPass = "default pass", zipDir = "d:/tmp/test/zip", 
        ...
        syncClient.sync(folder, zipDir, encryptionPass, workingPath, "tkSync")
