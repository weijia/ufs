...
users_email_address = "googleaccount@gmail.com"
users_password      = "passwd"

target_google_app_engine = 'http://wwjufsdatabase.appspot.com'
target_authenticated_google_app_engine_uri = target_google_app_engine+'/apps/test/mobileItem.py'
my_app_name = "wwjufsdatabase"
...
full_serv_uri = target_google_app_engine+"/_ah/login?%s" % (urllib.urlencode(serv_args))
